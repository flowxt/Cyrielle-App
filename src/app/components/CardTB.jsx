...
export default function CardTB({ imageSrc, title, content, buttonText }) {
  return (
    ...
    <article className="group relative h-full bg-gray-100 rounded-2xl overflow-hidden shadow-2xl shadow-red-900/30 hover:shadow-red-900/50 transition-all duration-300 hover:-translate-y-2 flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div 
          className="text-gray-600 font-roboto space-y-3 transition-colors duration-300 group-hover:text-gray-600 flex-grow mt-4"
