  ...
  return (
    <section className="relative py-16 ">
      ...
      <div className="relative z-10 container mx-auto px-4">
        {/* Titre */}
        <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-center mb-16 text-black font-poppins">NOS AVENTURES <span className="text-white bg-gradient-to-l from-red-700 to-red-900 p-2">AU CHÂTEAU</span></h2>
