...
const GoogleReviews = () => {
  return (
    <div className=" py-12 overflow-hidden">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-24 mt-12 font-poppins dark:text-gray-700">Témoignages de nos <span className='px-4 bg-red-800 text-white '>clients</span></h2>
