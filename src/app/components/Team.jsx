    ...
    return (
        <>
            <div className="container-team text-center py-6 flex flex-col items-center gap-8 border-t-2 border-b-2 border-red-700">
                ...
                <p className="font-roboto text-lg font-light px-4">Un duo complémentaire et passionné à l'écoute de vos besoins, garants d'une expérience unique et immersive.</p>
