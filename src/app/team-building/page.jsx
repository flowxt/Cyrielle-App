...
export default function TeamBuilding() {
    return (
      ...
      <div className="bg-gradient-to-b from-gray-200 to-gray-300">
        ...
        Découvrez nos activités stimulantes et <span className="text-red-600">fédératrice</span>.
        </h3>
...
A chaque besoin, un format adapté pour une expérience inédite de team building.</p>
    ...
    <main>
      <section>
        <h2 className="border-b-2 border-red-600 pb-12">Ici mes 3 cartes</h2>
      </section>
        <section className="grid grid-cols-1 md:grid-cols-5">
          <div className="md:col-span-3 bg-gradient-to-t from-gray-200 to-gray-400 px-12 text-center py-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:pb-12 font-semibold">Réinventons <span className="text-red-600">votre équipe</span></h2>
            <p className="text-lg">
...
Nous pouvons transformer votre équipe en une <b>véritable force sur la scène professionnelle</b>.
          ...
          <div className="md:col-span-2 grid grid-rows-2 md:gap-4 lg:pt-6">
